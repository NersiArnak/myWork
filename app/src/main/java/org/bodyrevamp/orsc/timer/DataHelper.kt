...
class DataHelper(context: Context) {
    ...
    private var dateFormat: SimpleDateFormat = SimpleDateFormat("MM/dd/yyyy HH:mm:ss", Locale.getDefault())
    ...
    fun startTime(): Date = startTime ?: Date()
    ...
    fun stopTime(): Date = stopTime ?: Date()
